...
export default function ApplicationRow({
  ...
  return (
    <div
      ...
      className="flex flex-col gap-3 lg:grid lg:grid-cols-[150px_110px_110px_1fr_140px_120px_60px] lg:gap-4 lg:items-center px-6 py-5 hover:bg-white/[0.03] cursor-pointer transition-colors"
    >
