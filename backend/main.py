...
from api.routes.form_routes import router as form_router

from api.routes.chat_thread_routes import router as chat_thread_router
...
from api.routes.application_evaluation_routes import (
    router as application_evaluation_routes,
)
